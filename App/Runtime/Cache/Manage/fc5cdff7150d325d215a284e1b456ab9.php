...
<head>
	...
	<script language="JavaScript">
	    ...
	    var SELF='/manage.php?s=/Abc/editDetail/id/3';
	...
	<div class="row">
		<div class="col-lg-12">
				...
				<form method='post' class="form-horizontal" id="form_do" name="form_do" action="<?php echo U('editDetail');?>">											
					...
					<div class="form-group">
						<label for="inputProps" class="col-sm-2 control-label">图片文字</label>
						<div class="col-sm-9">
							<input type="text" name="props" id="inputProps" value="<?php echo ($vo["pic_props"]); ?>" class="form-control" placeholder="图片文字" />
						</div>
					</div><?php break;?>
