...
<head>
	...
	<script language="JavaScript">
	    ...
	    var APP	 = '/xyhai.php?s=';
	    var SELF='/xyhai.php?s=/Member/index';
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <td><?php if(empty($v['login_time'])): ?>--<?php else: echo ($v["login_time"]); endif; ?></td>
                            <td><?php echo ($v["login_ip"]); ?></td>
                            <td><?php if($v['is_lock']): ?><span class="label label-default">锁定</span><?php else: ?><span class="label label-success">正常</span><?php endif; ?></td>
                            <td class="text-right">
