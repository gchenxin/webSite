...
<head>
	...
	<script language="JavaScript">
	    ...
	    var SELF='/manage.php?s=/Special/index';
...
<body>
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            ...
            <?php else: ?>
                <button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('Index_index');?>')"><em class="glyphicon glyphicon-chevron-left"></em> 返回</button>
