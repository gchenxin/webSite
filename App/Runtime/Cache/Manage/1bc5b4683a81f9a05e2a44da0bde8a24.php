...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/manage.php?s=/Abc';
	    var APP	 = '/manage.php?s=';
	    var SELF='/manage.php?s=/Abc/detail/aid/2';
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            <div class="btn-group btn-group-md">
                <button class="btn btn-default" type="button" onclick="goUrl('<?php echo U('Index_index');?>')"><em class="glyphicon glyphicon-chevron-left"></em> 返回</button>
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <td>
                                <?php if(empty($v['status'])): ?><span class="label label-default">停用</span>
                                <?php else: ?>
                                <span class="label label-info">启用</span><?php endif; ?>
                            </td>
