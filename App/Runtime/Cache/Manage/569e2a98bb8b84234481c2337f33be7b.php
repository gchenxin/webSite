...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/manage.php?s=/Model';
	    var APP	 = '/manage.php?s=';
	    var SELF='/manage.php?s=/Model/add';
		...
		<div class="col-lg-12">
				...
				<form method='post' class="form-horizontal" id="form_do" name="form_do" action="<?php echo U('add');?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="table_name" id="inputTablename" value="" class="form-control" placeholder="表名小写，去掉默认表前缀" required="required" />
