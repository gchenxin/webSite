...
<head>
	...
	<script language="JavaScript">
	    ...
	    var APP	 = '/xyhai.php?s=';
	    var SELF='/xyhai.php?s=/MemberGroup/index';
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            <div class="btn-group btn-group-md">           
                <button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('add');?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加会员组</button>              
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <td class="text-right">
                            <a href="<?php echo U('categoryAccess', array('id' => $v['id']));?>" class="label btn-info"><i class="glyphicon icon-cog"> </i>栏目权限</a>
                            <a href="<?php echo U('edit',array('id' => $v['id']));?>" class="label label-success">编辑</a>
                            <?php if($v['id'] > 3): ?><a href="javascript:;" onclick="toConfirm('<?php echo U('del',array('id' => $v['id']), '');?>', '确实要删除吗？')" class="label label-danger">删除</a><?php endif; ?>                       
                            </td>
