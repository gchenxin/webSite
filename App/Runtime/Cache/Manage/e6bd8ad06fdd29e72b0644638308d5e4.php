...
<head>
	...
	<script language="JavaScript">
	    ...
	    var SELF='/manage.php?s=/FreeBlock/index';
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            <div class="btn-group btn-group-md">
                <button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('add');?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加自由块</button>               
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <td><?php echo (get_item_value('blocktype',$v["block_type"])); ?></td>
                            <td class="aleft">&lt;yang:freeblock name='<?php echo ($v["name"]); ?>' /&gt; </td>
                            <td class="text-right">
