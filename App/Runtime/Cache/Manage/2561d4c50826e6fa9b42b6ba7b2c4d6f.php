...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/manage.php?s=/Special';
	    var APP	 = '/manage.php?s=';
	    var SELF='/manage.php?s=/Special/edit/id/1';
		...
		<div class="col-lg-12">
				...
				<form method='post' class="form-horizontal" id="form_do" name="form_do" action="<?php echo U('edit');?>">											
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select name="template" class="form-control">
								<?php if(is_array($styleShowList)): foreach($styleShowList as $key=>$v): ?><option value="<?php echo ($v); ?>" <?php if($vo['template'] == $v): ?>selected="selected"<?php endif; ?>><?php echo ($v); ?></option><?php endforeach; endif; ?>
							</select>					
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="filename" id="inputFilename" value="<?php echo ($vo["filename"]); ?>" class="form-control" placeholder="文件名只能由字母、拼音、英文组成" />	
							<div>文件名只能由字母、拼音、英文组成</div>					
						</div>
					</div>					
