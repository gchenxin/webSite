...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/manage.php?s=/Picture';
	    var APP	 = '/manage.php?s=';
	    var SELF='/manage.php?s=/Picture/index/pid/8';
...
<body>
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            ...
            <?php if(ACTION_NAME == "index"): ?><button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('add', array('pid'=>$pid));?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加图片集</button>
            ...
            <?php else: ?>
                <button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('Index_index', array('pid'=>$pid));?>')"><em class="glyphicon glyphicon-chevron-left"></em> 返回</button>
