...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/manage.php?s=/Product';
	    var APP	 = '/manage.php?s=';
	    var SELF='/manage.php?s=/Product/index/pid/5';
...
<body>
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            ...
            <?php if(ACTION_NAME == "index"): ?><button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('add', array('pid'=>$pid));?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加产品</button>
